...
2. Analisar as mudanças de código no bloco.
3. Classificar o tipo de commit: feat, fix, docs, style, refactor, perf, test, build, ci, chore, revert
4. Identificar o escopo (componente/módulo afetado) se aplicável
5. Gerar mensagem no formato: `type(scope): description`
6. Adicionar breaking changes com `!` se necessário: `type(scope)!: description`
7. Executar: `git add <arquivos-do-bloco>`
8. Executar: `git commit -m "mensagem-gerada"`
9. Confirmar sucesso ou reportar erro do commitlint
